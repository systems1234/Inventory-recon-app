    ...
    <div className="login-wrap">
      <div className="login-card">
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }}>
          <div className="login-mark" style={{ width: 38, height: 38, fontSize: 17, marginBottom: 0 }}>
            R
          </div>
          <div>
        ...
        <button onClick={() => signIn("google", { callbackUrl: "/dashboard" })} className="sso-btn">
        ...
        <div className="login-footer">Access is limited to accounts your admin has registered.</div>
      </div>
    </div>
  );
}
